  ...
  <div class="invoice-create-page main-content">
    <form v-if="!initLoading" action="" @submit.prevent="submitInvoiceData">
      <div class="page-header">
        <h3 v-if="$route.name === 'invoices.edit'" class="page-title">{{ $t('Edit') }}</h3>
        <h3 v-else class="page-title">{{ $t('Ticket') }} </h3>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><router-link slot="item-title" to="/admin/dashboard">{{ $t('general.home') }}</router-link></li>
          <li class="breadcrumb-item"><router-link slot="item-title" to="/admin/tickets">{{ $tc('Tickets', 2) }}</router-link></li>
          <li v-if="$route.name === 'tickets.edit'" class="breadcrumb-item">{{ $t('Ticket') }}</li>
          <li v-else class="breadcrumb-item">{{ $t('New Ticket') }}</li>
        </ol>
        ...
        <div class="col invoice-input">
          <div class="row mb-3">
            <div class="col collapse-input">
              <label>{{ $tc('',1) }} {{ $t('Booking Date') }}<span class="text-danger"> * </span></label>
              <base-date-picker
            ...
            <div class="col collapse-input">
              <label>{{ $t('Deperture Date') }}<span class="text-danger"> * </span></label>
              <base-date-picker
            ...
            <div class="col collapse-input">
              <label>{{ $t('Ticket Number') }}<span class="text-danger"> * </span></label>
              <base-prefix-input
          ...
          <div class="row mt-4">
            <div class="col collapse-input">
              <label>{{ $t('Service') }}</label>
                <base-select
                  v-model="newInvoice.service_name"
                  ...
                  @input="$v.newInvoice.service_name.$touch()"
                />
            ...
            <div class="col collapse-input">
              <label>{{ $t('Destination') }}</label>
                <base-select
                  ...
                  :tabindex="5"
                  :placeholder="$t('customers.select_currency')"
                  @input="$v.newEstimate.Destination.$touch()"
                />
...
export default {
  ...
  data () {
    return {
      options: ['Dhaka', 'Chittagong', 'Khulna', 'Barisal'],
      ServiceOptions: ['Service 1', 'Service 2', 'Service 3', 'Service 4'],
      newInvoice: {
        invoice_date: null,
        due_date: null,
        invoice_number: null,
